# Requires admin
# Get pageant
wsl wget https://github.com/benpye/wsl-ssh-pageant/releases/download/20201121.2/wsl-ssh-pageant-amd64-gui.exe
...
Set-Content "C:\Users\nick\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\start_ssh_pageant.bat" 'start "wsl-ssh-pageant-amd64-gui.exe --winssh ssh-pageant --systray"
'
